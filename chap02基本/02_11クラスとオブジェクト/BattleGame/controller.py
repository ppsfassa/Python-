from responder import * # responderモジュールのすべてのクラスをインポートする
...
class Controller:
    ...
    def __init__(self): 
        self.lucky = LuckyResponder() # LuckyResponderを生成      
        self.draw  = DrawResponder()  # MediumResponderを生成self.drawに代入        
        self.bad   = BadResponder()   # BadResponderを生成self.badに代入
...
if __name__  == '__main__':
    ...
    res = ctr.lucky.response(point) # 変動値を設定してresponse()メソッドを実行   
    print(res)              #応答を表示
